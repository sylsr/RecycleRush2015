 ...
 */public class IMUAdvanced extends IMU {
    ...
    private src.com.kauailabs.nav6.IMUProtocol.QuaternionUpdate quaternion_update_data;    
    ...
    public IMUAdvanced(SerialPort serial_port, byte update_rate_hz) {
        ...
        quaternion_update_data = new src.com.kauailabs.nav6.IMUProtocol.QuaternionUpdate();
        update_type = src.com.kauailabs.nav6.IMUProtocol.MSGID_QUATERNION_UPDATE;
    }
    ...
    protected int decodePacketHandler(byte[] received_data, int offset, int bytes_remaining) {
        ...
        int packet_length = src.com.kauailabs.nav6.IMUProtocol.decodeQuaternionUpdate(received_data, offset, bytes_remaining, quaternion_update_data);
        if (packet_length > 0) {
    ...
    private void setQuaternion(src.com.kauailabs.nav6.IMUProtocol.QuaternionUpdate raw_update) {
